...
dictatorship = mkCN(w.dictatorship_N)
theocracy = mkCN(w.theocracy_2_N)
condominium = mkCN(w.condominium_3_N)
...
#fam_dictatorship = mkCN(w.familial_1_A, w.dictatorship_N) # SPA / FRE
crown_colony = mkCN(w.royal_1_A, w.colony_5_N)
...
trans_government = mkCN(w.transitional_A, w.government_1_N) # SPA: gobierno de transición or gobierno provisional
...
sing_party_system = mkCN(w.single_party_system_N)
...
form_of_government = [
	...
	("Q317" , dictatorship),           # dictatorship
...
vat_products_in_use = {
   ...
   "library_1_N": {'ParseEng': aPl_Det, 'ParseSwe': aPl_Det, 'ParseBul': aPl_Det, 'ParseSpa': aPl_Det, 'ParseFre': thePl_Det, 'ParseRus': aPl_Det,},
   ...
   "hotel_N": {'ParseEng': aPl_Det, 'ParseSwe': aPl_Det, 'ParseSpa': aPl_Det, 'ParseFre': thePl_Det, 'ParseRus': thePl_Det},
   "book_1_N": {'ParseEng': aPl_Det, 'ParseSwe': aPl_Det, 'ParseBul': aPl_Det, 'ParseSpa': aPl_Det, 'ParseFre': thePl_Det, 'ParseRus': thePl_Det},
   "newspaper_3_N": {'ParseEng': aPl_Det, 'ParseSwe': aPl_Det, 'ParseBul': aPl_Det, 'ParseSpa': aPl_Det, 'ParseFre': thePl_Det, 'ParseRus': thePl_Det},
